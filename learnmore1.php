...
<header class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="index.php">Humanity Connect</a>
...
<section class="hero-section">
    <div class="container">
        ...
        <a href="index.php" class="btn btn-light btn-lg rounded-pill px-5 py-3 shadow-sm">Explore Activities</a>
    </div>
</section>
