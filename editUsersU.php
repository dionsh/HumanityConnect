<?php 
 ...
 <html>
 <head>
 	<title>Edit or Update Users - HumanityConnect</title>
...
<style>
 ...
 <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow" style="background-color:#1877F2 !important;">
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Update or Edit users</h1>
      ...
      <div class="table-responsive">
        ...
        <form action="updateUsersU.php" method="post">
